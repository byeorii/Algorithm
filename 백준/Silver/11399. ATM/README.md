...
### 출력 
 ...
 ### 문제 풀이
<p>기다리는 시간을 sort 해서 구간합을 구하는게 최소 시간 구하는 방법이다.</p>
<p>array의 길이만큼 반복해서 tmp 통해 각자 기다린 값을 구한다. 처음에는 1분 그다음에는 2분, 3분, 3분 이렇게 더해간다</p>
<p>각자 기다린 값들을 전체 더하기 위해 sum 을 0으로 두고 각자 기다린 시간의 합을 구한다.</p>
